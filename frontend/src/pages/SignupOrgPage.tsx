      ...
      <div className="flex-1 flex items-center justify-center py-16 px-6">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full transform transition-all duration-700 opacity-100 translate-y-0">
          <div className="bg-gradient-to-r from-purple-600 to-purple-500 rounded-t-xl -mt-8 -mx-8 p-4 flex items-center justify-center">
            <Building2 className="w-8 h-8 text-yellow-400 mr-2" />
            <h1 className="text-2xl font-bold text-white">Organization Sign Up</h1>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 mt-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray-800 font-semibold">Organization Name</FormLabel>
                    <FormControl>
                      <Input
              ...
              <Button
                type="submit"
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-purple-600 font-semibold rounded-full py-2.5 transform hover:scale-100 transition-all duration-200 flex items-center justify-center group"
                disabled={isLoading}
              >
                {isLoading ? (
