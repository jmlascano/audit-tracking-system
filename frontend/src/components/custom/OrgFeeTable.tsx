    ...
    if (filters.search) {
      ...
      switch (filters.searchType) {
        ...
        case 'member_name':
          ...
          break;
        case 'sem_ay':
          const semAY = formatSemAY(fee.sem_issued, fee.acad_year_issued).toLowerCase();
          if (!semAY.includes(searchLower)) return false;
          break;
        default:
          if (
        ...
        >
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-4xl font-bold bg-gradient-to-r from-yellow-400 to-purple-600 bg-clip-text text-transparent font-sans">
                  Fee Management
                </h1>
                <p className="text-gray-600 mt-1 font-sans text-lg">Track and manage organization fees</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
              <div className="flex gap-2">
                ...
                >
                  <SelectTrigger className="w-40 h-12 border-2 border-purple-200 rounded-2xl focus:ring-4 focus:ring-purple-100 focus:border-purple-400 bg-white/70 backdrop-blur-sm">
                ...
                <div className="relative group">
                  <Input
                    className="w-full sm:w-72 h-12 border-2 border-purple-200 rounded-2xl focus:ring-4 focus:ring-purple-100 focus:border-purple-400 pl-12 pr-12 bg-white/70 backdrop-blur-sm transition-all duration-300 placeholder:text-gray-400 font-sans text-base"
              ...
              <div className="flex gap-2">
                <Button
                  className="h-12 bg-yellow-400 hover:bg-yellow-500 text-purple-800 font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
          ...
          <AnimatePresence>
            {!isFiltering && (
              <motion.div
                ...
                className="flex-1 rounded-lg border-1 border-purple-200 bg-gradient-to-br from-purple-50 to-white-50 shadow-lg p-2 min-w-0"
                  ...
                  <Table className="w-full">
                    <TableHeader>
                      <TableRow className="font-bold bg-gradient-to-br from-purple-100 to-purple-50 rounded-lg shadow-lg">
                        ...
                        <TableHead className="text-center font-bold text-gray-800">Sem/AY</TableHead>
                    ...
                    <TableBody>
                      {filteredFees.map((fee, index) => (
                        ...
                        >
                          ...
                          <TableCell className="text-gray-600">{formatSemAY(fee.sem_issued, fee.acad_year_issued)}</TableCell>
                          <TableCell>
